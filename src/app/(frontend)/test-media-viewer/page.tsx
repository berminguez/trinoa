    ...
    <div className='container mx-auto py-8 px-4 max-w-4xl'>
      ...
      <Card className='mb-6'>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='border-l-4 border-green-500 pl-4 py-2 bg-green-50 rounded-r'>
            ...
            <code className='text-sm text-green-800 break-all'>/media/documentos/archivo.pdf</code>
      ...
      <Card className='mb-6'>
        <CardHeader>
          ...
          <CardDescription>
            Abre estos links en una <strong>ventana de incógnito</strong> para simular usuario sin
            login
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
      ...
      <Card className='mt-6'>
        ...
        <CardContent className='space-y-3 text-sm'>
          ...
          <code className='block bg-gray-100 p-3 rounded text-xs break-all'>
            https://atria.trinoa.es/api/media?key=documentos/manual-usuario.pdf
          </code>

          <p className='font-medium'>
            Toma solo lo que está después de <code>key=</code>:
          </p>
          ...
          <code className='block bg-green-100 p-3 rounded text-xs break-all'>
            https://atria.trinoa.es/media/documentos/manual-usuario.pdf
          </code>
        </CardContent>
      </Card>
    </div>
